...
图 8: 样本三第二部分部分数据插值前（原图已失效）

经过插值后, 结果如下图所示:


图 9: 样本三第二部分部分数据插值后（原图已失效）
...
图 10: 第二组数据离群点处理前（原图已失效）


图 11: 第二组数据离群点处理后（原图已失效）

2.2 去噪

图 12: 第二组数据去噪处理后（原图已失效）
...
图 15: 第三组数据去离群点前（原图已失效）

图 16: 第三组数据去离群点后（原图已失效）
