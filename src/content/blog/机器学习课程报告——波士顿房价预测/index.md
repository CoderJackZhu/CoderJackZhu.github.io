...
图 6: 城镇非商业用地比例图（原图已失效）


图 7: 是否处于查尔斯河边图（原图已失效）
...
图 10: 1940 年前建成业主自住比例图（原图已失效）


图 11: 距离 5 个波士顿就业中心的距离图（原图已失效）

图 12: 距离高速公路的便利指数图（原图已失效）


图 13: 每一万美元的不动产税率图（原图已失效）

图 14: 城镇中学教师比例图（原图已失效）
